...
public abstract class BaseDialog extends DialogFragment {
    ...
    public void setDialogFullSCreen() {
        if (getDialog().getWindow() != null) {
            getDialog().getWindow().setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.clr_F2F2F2)));
    ...
    public void refreshCompanyKey() {
        if (getActivity() != null) {
            startActivity(new Intent(getActivity(), CompanyValidationActivity.class));
            getActivity().finish();
        }
    }
