...
import taxi.ratingen.databinding.ItemAdditionalChargeHistoryBinding;
...
public class AddChargeHistoryAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    Integer selected_id;
    HistoryDetailsScrn baseActivity;
    String currency;

    public AddChargeHistoryAdapter(String currency, ArrayList<Bill.AdditionalCharge> manageDocModels_,
                                   HistoryDetailsScrn drawerAct) {
