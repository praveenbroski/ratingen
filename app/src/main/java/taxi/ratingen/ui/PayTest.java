...
public class PayTest extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toLiveData(IZettleSDK.Instance.getUser().getState()).observe(this, authState -> onUserAuthStateChanged(authState instanceof User.AuthState.LoggedIn));
    ...
    private void onLoginClicked() {
        IZettleSDK.Instance.getUser().login(this, ResourcesCompat.getColor(getResources(), R.color.clr_FB4A46, null));
    }
    ...
    private class RefundCallback implements RefundsManager.Callback<CardPaymentPayload, RetrieveCardPaymentFailureReason> {
        ...
        public void onFailure(RetrieveCardPaymentFailureReason reason) {
            Toast.makeText(PayTest.this, "Refund failed", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onSuccess(CardPaymentPayload payload) {
            ...
            Intent intent = new RefundsActivity.IntentBuilder(PayTest.this)
                    .cardPayment(payload)
